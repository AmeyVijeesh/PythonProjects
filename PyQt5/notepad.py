"""
@author: Amey
Notepad created using the Pyqt5 module in python along with steps
"""
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        clear_action.setStatusTip("Clear everything")
    ...
    def update_title(self):
        ...
        self.setWindowTitle("%s - Notepad by Amey" % (os.path.basename(self.path)
...
if __name__ == '__main__':
    ...
    app.setApplicationName("Notepad by Amey")
